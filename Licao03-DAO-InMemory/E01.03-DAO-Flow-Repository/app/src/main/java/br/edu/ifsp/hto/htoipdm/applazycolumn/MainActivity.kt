...
fun ListaAniversarios() {
    val pessoaRepository = remember { PessoaRepository(PessoaDAOImpl()) }

    val pessoas by pessoaRepository.listar().collectAsState(
        initial = emptyList()
    )
            ...
            onClick = {
                ...
                selectedDate?.let { date ->
                    scope.launch {
                        ...
                        } ?: pessoaRepository.inserir(nome, date)
                        nome = ""
                        selectedDate = null
                        pessoaEdicao = null
                    }
                ...
                Card(
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                scope.launch {
                                    pessoaRepository.remover(id = pessoa.id)
                                }
                            }
                        ) {
